...
$editPageName = "manage-projects.php";
...
<head>
    ...
    <title>Admin Site Portfolio - All Projects</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top" id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)">All Projects</a>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($row['image_name'])): ?>
                                                        <img class="table-img"
                                                            src="../../upload-img/projects/<?= htmlspecialchars($row['image_name']) ?>"
                                                            alt="project image"
