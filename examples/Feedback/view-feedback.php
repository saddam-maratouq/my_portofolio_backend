...
<head>
    ...
    <title>Admin Site Portfolio - All Feedback</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top" id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)">All Feedback</a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        <tr>
                                            ...
                                            <td style="max-width: 400px;"><?= htmlspecialchars($row['feedback']) ?></td>
                                            <td>
                                                <?php if (!empty($row['image_name'])): ?>
                                                    <img class="table-img"
                                                        src="../../upload-img/feedback/<?= htmlspecialchars($row['image_name']) ?>"
                                                        alt="client image"
                                            ...
                                            <td>
                                                <a href="<?= $editPageName ?>?id=<?= $row['id'] ?>&edit_data=true"
                                                    class="text-white me-3" title="Edit">
