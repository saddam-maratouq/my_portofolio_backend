...
$editPageName = "mange-feedback.php";

# delete record with image deletion
$delete_id = isset($_GET['id']) ? $_GET['id'] : null;

if (is_numeric($delete_id) && $delete_id > 0) {

    // need current img here to delete it ....
    $sql = "SELECT `user_img` from $tableName where id = $delete_id limit 1";
    $result = mysqli_query($connect, $sql);
    $current_data = mysqli_fetch_assoc($result);

    $existingImg = $current_data['user_img'] ?? null;
    ...
    deleteRecord($tableName, $delete_id, $connect);
}
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper   ">
                        <a class="navbar-brand" href="javascript:void(0) text-white  "> All feedback </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse justify-content-end">
                        <form class="navbar-form" onsubmit="searchPageRedirect(event)">
                            <div class="input-group no-border">
                                <input type="text" value="" id="searchInput" class="form-control"
                                    placeholder="Search...">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown ">
                                ...
                                <div class="dropdown-menu  dropdown-menu-right" style="width: 500px;"
                                    ...
                                    <a class="dropdown-item " href="../orders-history/orders-details.php"> order
                                        received </a>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td style="max-width: 300px; word-wrap: break-word; text-align: left;">
                                            <?= nl2br(htmlspecialchars($row['feedback_details'])) ?>
                                        </td>
                                        <td>
                                            <?php if (!empty($row['user_img'])): ?>
                                                <img src="../../upload-img/feedback/<?= htmlspecialchars($row['user_img']) ?>" 
                                                    alt="user image" 
                                                    class="table-img"
                                                   />
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <a href="<?= $editPageName ?>?id=<?= $row['id'] ?>&edit_data=true" 
