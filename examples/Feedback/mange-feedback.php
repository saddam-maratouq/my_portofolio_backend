...
{
    global $client_name, $feedback, $image_name;
...
if (isset($_POST['add'])) {
    ...
    $fileTarget = '../../upload-img/feedback/';
    $prefix = 'feedback';
    $formFileName = 'image_name';

    uploadFile($uploadfileName, $fileTarget, $formFileName, $prefix);

    $stmt = $connect->prepare("INSERT INTO $tableName (`image_name`, `client_name`, `feedback`) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $finalFileName, $client_name, $feedback);
...
if (isset($_POST['update'])) {
    ...
    $prefix = 'feedback';
    $targetFileDirectory = '../../upload-img/feedback/';
    $formFileName = 'image_name';
    ...
    $stmt = $connect->prepare("UPDATE $tableName SET `client_name` = ?, `feedback` = ?, `image_name` = ? WHERE `id` = ?");
    $stmt->bind_param("sssi", $client_name, $feedback, $updateUploadFileName, $editId);
...
<head>
    ...
    <title>Admin Site Portfolio - Feedback</title>
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item side dropdown active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="trainingDropdown">
                            <li><a class="dropdown-item" href="manage-feedback.php">Add</a></li>
                            <li><a class="dropdown-item" href="view-feedback.php">View All</a></li>
                        </ul>
                    </li>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top" id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)"> <?= $editData ? 'Update' : 'Add' ?> Feedback</a>
                    </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="width: 500px;"
                                    ...
                                    <a class="dropdown-item" href="orders-details.php">msg received</a>
                                </div>
                            </li>

                            <li class="nav-item dropdown custom-dropdown">
                                <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="accountDropdown"
                                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <form action="" method="POST" class="mt-5" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="client_name" class="form-control" required
                                    value="<?= $editData ? htmlspecialchars($current_data['client_name'] ?? '', ENT_QUOTES, 'UTF-8') : '' ?>">
                            </div>

                            <div class="mb-4">
                                <label class="text-white">Feedback</label>
                                <textarea name="feedback" class="form-control" rows="4" required><?= $editData ? htmlspecialchars($current_data['feedback'] ?? '', ENT_QUOTES, 'UTF-8') : '' ?></textarea>
                                <small class="text-muted">Client's testimonial or feedback</small>
                            </div>
                                ...
                                <?php if ($editData && !empty($current_data['image_name'])): ?>
                                    <div class="mt-3">
                                        <img src="../../upload-img/feedback/<?= htmlspecialchars($current_data['image_name']) ?>"
                                            alt="Current image" style="width: 60px; height: 60px; object-fit: cover; border-radius: 50%;">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <nav class="float-left">
                        <ul>
                            <li><a href="https://www.creative-tim.com">Creative Team</a></li>
            ...
            <ul class="dropdown-menu">
                ...
                <li class="button-container">
                    <a href="https://demos.creative-tim.com/material-dashboard-dark/docs/2.0/getting-started/introduction.html"
                        target="_blank" class="btn btn-default btn-block">View Documentation</a>
                </li>
