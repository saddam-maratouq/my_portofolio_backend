...
if (isset($_POST['submit'])) {
    ...
    #  check if err before  insert first record ... 

    if (empty($errors) && !$isErr ) {
        // echo "avoid err catch" ; 
        // die() ; 

        if ($countRows === 0) {

            $stmt = $connect->prepare("INSERT INTO $tableName ( `phone_number`, `email`, `address`) VALUES (?, ?, ?)");

            $stmt->bind_param("sss", $phoneNumber, $email, $address);


            if ($stmt->execute()) {
                header("Location: ?msg=record-added-success");
                exit();
            ...
            // UPDATE (since record already exists one at least )
        } else {


$stmt = $connect->prepare("UPDATE $tableName SET `phone_number`=?, `email`=?, `address`=? WHERE id=?");

$stmt->bind_param("sssi", $phoneNumber, $email, $address, $currentId);
...
if ($stmt->execute()  ) {
    ...
    <div id="success-msg" style="text-align:center; background:green; color:white; padding:10px;">
        ...
        <script>
            setTimeout(function() {
                window.location.href = "?msg=update-record-successfully";
            }, 1000 / 2 );
        </script>
    </div>';
        } else {
            ...
            '<script>
            setTimeout(function() {
        <div style="text-align:center; background:red; color:white;">Record update failed ❌</div>
            }, 2000);
        </script> ';
        }
        ...
        <div class="sidebar-wrapper">
            ...
            <li class="nav-item side dropdown  ">
              ...
              <ul class="dropdown-menu" aria-labelledby="userDropdown">
                <li> <a class="dropdown-item  " href="../web-logo/mange-web-logo.php">Mange Web Logo</a> </li>
              </ul>
            </li>
            ...
            <li class="nav-item side dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="trainingDropdown">
                <li><a class="dropdown-item" href="../hero/mange-hero.php">Add Slider</a></li>
            ...
            <!-- <li class="nav-item side dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="trainingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <p class="text-white">Special Meal</p>
              </a>
              <ul class="dropdown-menu" aria-labelledby="trainingDropdown">
                <li><a class="dropdown-item" href="../special-meal/mange-special-meal.php">Add Meal</a></li>
                <li><a class="dropdown-item" href="../special-meal/view-special-meal.php">View All</a></li>
              </ul>
            </li> -->
           ...
           <!-- dropdown tab  about  -->
            ...
            <!-- dropdown tab Menu cart     -->
            <li class="nav-item side dropdown ">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="material-icons">local_dining</i>
                <p class="text-white">Menu Cart</p>
              </a>
              <ul class="dropdown-menu" aria-labelledby="userDropdown">

               <!-- sub menu -->
                <li class="dropdown-submenu  position-relative ">
                  <a class="dropdown-item dropdown-toggle" role="button">Starters</a>
                  <ul class="dropdown-menu right-submenu">
                    <li><a class="dropdown-item" href="../home/Starters/mange-starters.php">Add Starters</a></li>
                    <li><a class="dropdown-item" href="../home/Starters/view-starters.php">View All</a></li>
                  </ul>
                </li>

                <!-- sub menu -->
                <li class="dropdown-submenu  position-relative ">
                  <a class="dropdown-item dropdown-toggle" role="button">Main Dishes </a>
                  <ul class="dropdown-menu right-submenu">
                    <li><a class="dropdown-item" href="../home/Main-Dishes/mange-main-dish.php">Add Dish</a></li>
                    <li><a class="dropdown-item" href="../home/Main-Dishes/view-main-dish.php">View All</a></li>
                  </ul>
                </li>

                  <!-- sub menu -->
                <li class="dropdown-submenu  position-relative ">
                  <a class="dropdown-item dropdown-toggle" role="button">Desserts</a>
                  <ul class="dropdown-menu right-submenu">
                    <li><a class="dropdown-item" href="../home/Desserts/mange-desserts.php">Add Desserts</a></li>
                    <li><a class="dropdown-item" href="../home/Desserts/view-desserts.php">View All</a></li>
                  </ul>
                </li>

                  <li class="dropdown-submenu  position-relative ">
                  <a class="dropdown-item dropdown-toggle" role="button">Drinks</a>
                  <ul class="dropdown-menu right-submenu">
                    <li><a class="dropdown-item" href="../home/Drinks/mange-drinks.php">Add Drinks</a></li>
                    <li><a class="dropdown-item" href="../home/Drinks/view-drinks.php">View All</a></li>
                  </ul>
                </li>
            ...
            <li class="nav-item side dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="trainingDropdown">
                ...
                <!-- CHANGED: "View All" → "View messages" -->
                <li><a class="dropdown-item" href="../messages/view-messages.php">View All messages</a></li>
              </ul>
            </li>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper   ">
                        <a class="navbar-brand" href="javascript:void(0) text-white  "> <?= $countRows > 0  ? 'Update' : 'Add'  ?> Contact</a>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <form action="" method="POST" class="mt-5"   >
                            ...
                            <div class="mb-4">
                                ...
                                <input type="tel" name="phone" class="form-control" maxlength="15" required
                                    pattern="[0-9+\-\s]+"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" name="email" class="form-control" required
                                    value="<?= $countRows > 0 ? htmlspecialchars($current_data['email'] ?? '') : '' ?>">
                                

                                <?= (!empty($errors)) ?   "<small class='text-danger'>$errors</small>"  :  ''  ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="address" class="form-control" required
                                    value="<?= $countRows > 0 ? htmlspecialchars($current_data['address'] ?? '') : '' ?>">
                            </div>
