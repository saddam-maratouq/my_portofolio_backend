...
if ( is_numeric($deleteID) &&  $deleteID > 0 ) {
  ...
  $filePath = "../../../upload-img/our-menu/pizza/";
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper   ">
            <a class="navbar-brand" href="javascript:void(0) text-white  "> All Pizzas</a>
          </div>
      ...
      <tr>
        ...
        <td>
          <?php if (!empty($row['img_name'])): ?>
            <img class="table-img"  src="../../../upload-img/our-menu/pizza/<?= htmlspecialchars($row['img_name']) ?>" 
                 alt="pizza image" 
                 >
          <?php else: ?>
