...
if (isset($_POST['add'])) {
  ...
  $uploadfileName  =  $_FILES['pizza_img']['name'] ?? null; // updated 

  # updated frequently ...  

  $fileTarget = '../../../upload-img/our-menu/pizza/';

  $prefix = 'pizza';

  $formFileName = 'pizza_img';  // from form name ex :  $_FILES['pizza_img'] 
...
if (isset($_POST['update'])) {
  ...
  $uploadFileName =  $_FILES['pizza_img']['name'] ?? '';
  ...
  $targetFileDirectory = '../../../upload-img/our-menu/pizza/';

  $formFileName = 'pizza_img';
  // 
  ...
  if ($stmt->execute()) {
    updateRecordMsg('view-pizzas.php');
  } else {
          ...
          <li class="nav-item side dropdown alert-warning">
            ...
            <ul class="dropdown-menu" aria-labelledby="userDropdown">
              ...
              <li class="dropdown-submenu position-relative">
                ...
                <ul class="dropdown-menu right-submenu">
                  <li><a class="dropdown-item" href="mange-pizza.php">Add</a></li>
                  <li><a class="dropdown-item" href="view-pizzas.php">View All</a></li>
                </ul>
              </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper   ">
            <a class="navbar-brand" href="javascript:void(0) text-white  "> <?= $editData ? 'Update' : 'Add' ?> Pizza
            </a>
          </div>
        ...
        <div class="container-fluid">
          <div class="col-xl-12 col-lg-12">
            ...
            <form action="" method="POST" class="mt-5" enctype="multipart/form-data">
              ...
              <div class="mb-5">
                <label class="text-white">Pizza Name</label>
              ...
              <div class="mb-5">
                <label class="text-white">Pizza Image</label>
                <input type="file" name="pizza_img" class="form-control" accept="image/*" <?= $editData ? '' : 'required' ?>
                  title="<?= mangeLimitedTitle() ?>"
                  <?= mangeLimitedRecord() ?>>
                <small class="text-muted">Allowed: JPG, JPEG, PNG, GIF, WEBP (Max: 5MB)</small>
                <?php if ($editData && !empty($current_data['img_name'])): ?>
                  <div class="mt-3">
                    <img src="../../../upload-img/our-menu/pizza/<?= htmlspecialchars($current_data['img_name']) ?>"
