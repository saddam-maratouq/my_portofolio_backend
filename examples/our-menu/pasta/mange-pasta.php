...
if (isset($_POST['add'])) {
  ...
  $uploadfileName  =  $_FILES['pasta_img']['name'] ?? null; 

  # updated frequently ...  

  $fileTarget = '../../../upload-img/our-menu/pasta/';

  $prefix = 'pasta';

  $formFileName = 'pasta_img';  // from form name ex :  $_FILES['pasta_img'] 
...
if (isset($_POST['update'])) {
  ...
  $uploadFileName =  $_FILES['pasta_img']['name'] ?? '';
  ...
  $targetFileDirectory = '../../../upload-img/our-menu/pasta/';

  $formFileName = 'pasta_img';
  // 
  ...
  if ($stmt->execute()) {
    updateRecordMsg('view-pastas.php');
  } else {
          ...
          <li class="nav-item side dropdown alert-warning">
            ...
            <ul class="dropdown-menu" aria-labelledby="userDropdown">
              ...
              <li class="dropdown-submenu position-relative">
                ...
                <ul class="dropdown-menu right-submenu">
                  <li><a class="dropdown-item" href="mange-pasta.php">Add</a></li>
                  <li><a class="dropdown-item" href="view-pastas.php">View All</a></li>
                </ul>
              </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper   ">
            <a class="navbar-brand" href="javascript:void(0) text-white  "> <?= $editData ? 'Update' : 'Add' ?> Pasta
            </a>
          </div>
        ...
        <div class="container-fluid">
          <div class="col-xl-12 col-lg-12">
            ...
            <form action="" method="POST" class="mt-5" enctype="multipart/form-data">
              ...
              <div class="mb-5">
                <label class="text-white">Pasta Name</label>
              ...
              <div class="mb-5">
                <label class="text-white">Pasta Image</label>
                <input type="file" name="pasta_img" class="form-control" accept="image/*" <?= $editData ? '' : 'required' ?>
                  title="<?= mangeLimitedTitle() ?>"
                  <?= mangeLimitedRecord() ?>>
                <small class="text-muted">Allowed: JPG, JPEG, PNG, GIF, WEBP (Max: 5MB)</small>
                <?php if ($editData && !empty($current_data['img_name'])): ?>
                  <div class="mt-3">
                    <img src="../../../upload-img/our-menu/pasta/<?= htmlspecialchars($current_data['img_name']) ?>"
