...
$tableName = "menu_burger";

$maxLimited =  9  ;    // updated  depend on case  limit change of  for test 6 change to 9 later  
...
if (isset($_POST['add'])) {
  ...
  $uploadfileName  =  $_FILES['burger_img']['name'] ?? null;

  # updated frequently ...  

  $fileTarget = '../../../upload-img/our-menu/burger/';

  $AllFilesPath = '../../../upload-img/our-menu/all-meals/'; // for cart meals show 

  $prefix = 'burger';

  $formFileName = 'burger_img';  // from form name ex :  $_FILES['burger_img'] 

  # 


  uploadFileToDirectories($uploadfileName, $fileTarget, $AllFilesPath , $formFileName, $prefix);
...
if (isset($_POST['update'])) {
  ...
  $uploadFileName =  $_FILES['burger_img']['name'] ?? '';
  ...
  $targetFileDirectory = '../../../upload-img/our-menu/burger/';

  $secFileDirectory = '../../../upload-img/our-menu/all-meals/' ; 

  $formFileName = 'burger_img';
  // 

  updateUploadFileToDirectories(
    $uploadFileName,
     $existFile, $formFileName,
    $prefix, 
    $targetFileDirectory ,  
    $secFileDirectory 
  );
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper   ">
            <a class="navbar-brand" href="javascript:void(0) text-white  "> <?= $editData ? 'Update' : 'Add' ?> Burger
            </a>
          </div>
        ...
        <div class="container-fluid">
          <div class="col-xl-12 col-lg-12">
            ...
            <form action="" method="POST" class="mt-5" enctype="multipart/form-data">
              ...
              <div class="mb-5">
                <label class="text-white">Burger Name</label>
              ...
              <div class="mb-5">
                <label class="text-white">Burger Image</label>
                <input type="file" name="burger_img" class="form-control" accept="image/*" <?= $editData ? '' : 'required' ?>
                  title="<?= mangeLimitedTitle() ?>"
                  <?= mangeLimitedRecord() ?>
                  >
                ...
                <?php if ($editData && !empty($current_data['img_name'])): ?>
                  <div class="mt-3">
                    <img src="../../../upload-img/our-menu/burger/<?= htmlspecialchars($current_data['img_name']) ?>"
