...
if (isset($_POST['submit'])) {
    ...
    # insert first record ... 
    if ($countRows === 0) {
        $stmt = $connect->prepare("INSERT INTO $tableName (`linkedin`, `github`) VALUES (?, ?)");
        $stmt->bind_param("ss", $linkedin, $github);
    ...
    #  update record only ....    
        ...
        $stmt = $connect->prepare("UPDATE $tableName SET `linkedin` = ?, `github` = ? WHERE id = ?");
        $stmt->bind_param("ssi", $linkedin, $github, $currentId);

        if ($stmt->execute()) {
            updateRecordMsg('mange-footer.php');
        } else {
...
<head>
    ...
    <title>Admin Site Portfolio - Contact Info</title>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item side dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="newsDropdown">
                            <li><a class="dropdown-item" href="../about/mange-about.php">Add</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item side dropdown active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="contactDropdown">
                            <li><a class="dropdown-item" href="manage-contact.php">Manage</a></li>
                        </ul>
                    </li>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top" id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)"> <?= $countRows > 0 ? 'Update' : 'Add' ?> Contact Info</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <form action="" method="POST" class="mt-5">
                            ...
                            <div class="mb-4">
                                <label class="text-white">LinkedIn URL</label>
                                <input type="url" name="linkedin" class="form-control"
                                    placeholder="https://www.linkedin.com/in/yourprofile" required
                                    value="<?= $countRows > 0 ? htmlspecialchars($current_data['linkedin'] ?? '') : '' ?>">
                                <small class="text-muted">Enter your LinkedIn profile URL</small>
                            </div>

                            <div class="mb-4">
                                <label class="text-white">GitHub URL</label>
                                <input type="url" name="github" class="form-control"
                                    placeholder="https://github.com/yourusername" required
                                    value="<?= $countRows > 0 ? htmlspecialchars($current_data['github'] ?? '') : '' ?>">
                                <small class="text-muted">Enter your GitHub profile URL</small>
                            </div>
