...
$facebookUrl = mysqli_real_escape_string($connect, trim($_POST['facebook_url'] ?? ''));
$instagramUrl = mysqli_real_escape_string($connect, trim($_POST['instgram_url'] ?? ''));
        ...
        <a href="http://www.creative-tim.com" class="simple-text logo-normal">
          ...
          <ul class="nav">
            ...
            <li class="nav-item side dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="trainingDropdown">
                <!-- <li><a class="dropdown-item" href="../special-meal/mange-special-meal.php">Add </a></li> -->
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper   ">
           <a class="navbar-brand" href="javascript:void(0) text-white  "> <?= $countRows > 0  ? 'Update' : 'Add'  ?> footer </a>
          </div>
  ...
  <div class="container-fluid">
    <div class="col-xl-12 col-lg-12">
      ...
      <form action="" method="POST" class="mt-5" >
              ...
              <div class="mb-4">
          <label class="text-white">Facebook Link</label>
          <input type="text" name="facebook_url" class="form-control" required
          value="<?= $countRows > 0 ? htmlspecialchars($current_data['facebook_url'] ?? '') : '' ?>">
      </div>
        ...
        <div class="mb-4">
            <label class="text-white">Instagram Link</label>
            <input type="text" name="instgram_url" class="form-control" required
            value="<?= $countRows > 0 ? htmlspecialchars($current_data['instagram_url'] ?? '') : '' ?>">
        </div>
