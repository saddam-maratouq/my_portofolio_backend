...
$maxLimited =   4  ;    // updated  depend on case  limit change of  for test 6 change to 9 later  
...
{
 global $title, $description, $image_name;
...
if (isset($_POST['add'])) {
  ...
  $fileTarget = '../../upload-img/services/';

  $prefix = 'service';

  $formFileName = 'image_name';  // from form name ex :  $_FILES['burger_img'] 
 ...
 $stmt = $connect->prepare("INSERT INTO $tableName (`image_name`, `title`, `description`) VALUES (?, ?, ?)");

// Bind parameters
$stmt->bind_param("sss", $finalFileName ,   $title, $description); 
...
if (isset($_POST['update'])) {
  ...
  $targetFileDirectory = '../../upload-img/services/';
        ...
        <div class="sidebar-wrapper">
          ...
          <li class="nav-item side dropdown alert-warning  ">
            ...
            <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
              <li><a class="dropdown-item" href="manage-services.php">Manage Services</a></li>
              <li><a class="dropdown-item" href="view-services.php"> View All </a></li>
            </ul>
          </li>
         <!--  -->
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper   ">
            <a class="navbar-brand" href="javascript:void(0) text-white  "> <?= $editData ? 'Update' : 'Add' ?> Service
            </a>
          </div>
   ...
   <form action="" method="POST" class="mt-5" enctype="multipart/form-data">
    ...
    <div class="mb-5">
        ...
        <input type="text" name="title" class="form-control" required
            ...
            value="<?= $editData ? htmlspecialchars($current_data['title'] ?? '', ENT_QUOTES, 'UTF-8') : '' ?>"
            <?= mangeLimitedRecord() ?>>
    </div>
    ...
    <div class="mb-5">
        ...
        <textarea name="description" class="form-control" rows="4" required
            title="<?= mangeLimitedTitle() ?>"
            <?= mangeLimitedRecord() ?>><?= $editData ? htmlspecialchars($current_data['description'] ?? '', ENT_QUOTES, 'UTF-8') : '' ?></textarea>
        <small class="text-muted">Max 500 characters</small>
    </div>

    <div class="mb-5">
        <label class="text-white">Service Image</label>
