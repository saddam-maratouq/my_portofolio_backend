...
if (isset($_POST['add'])) {
    ...
    // Updated frequently
    $fileTarget = '../../upload-img/experince-technology/';
    $prefix = 'experience';
    $formFileName = 'image_name';
    // 
    uploadFile($uploadFileName, $fileTarget, $formFileName, $prefix);
    
    $stmt = $connect->prepare("INSERT INTO $tableName (`image_name`) VALUES (?)");
    $stmt->bind_param("s", $finalFileName);
...
if (isset($_POST['update'])) {
    ...
    // Updated freq
    $prefix = 'experience';
    $targetFileDirectory = '../../upload-img/experince-technology/';
    $formFileName = 'image_name';
    ...
    // UPDATE statement
    $stmt = $connect->prepare("UPDATE $tableName SET `image_name` = ? WHERE `id` = ?");
...
<head>
    ...
    <title>Admin Site Portfolio - Experience Gallery</title>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item side dropdown active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="experienceDropdown">
                            <li><a class="dropdown-item" href="mange-experience.php">Add Image</a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top" id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)"><?= $editData ? 'Update' : 'Add' ?> Technology </a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <form action="" method="POST" class="mt-5" enctype="multipart/form-data">
                            ...
                            <div class="mb-5">
                                <label class="text-white">Experience Image</label>
