...
$editPageName = "mange-technology.php";
...
if (is_numeric($deleteID) && $deleteID > 0) {
    ...
    $filePath = "../../upload-img/experince-technology/";
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top" id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)"> Experience Gallery</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($row['image_name'])): ?>
                                                    <img class="table-img"
                                                        src="../../upload-img/experince-technology/<?= htmlspecialchars($row['image_name']) ?>"
